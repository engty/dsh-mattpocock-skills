...
> DSH note: in this harness the **default** deliverable is an inline GenUI report (see SKILL.md step 2). This file is the guide for the **optional portable artifact**: a self-contained HTML the user can keep or share. Write it when the user wants a file, deliver it with the `present` tool, and delete previous reports rather than accumulating copies.
